...
import {required, min, max, alpha_spaces as alphaSpaces, email, min_value as minValue, 
    max_value as maxValue, confirmed as confirmed, not_one_of as excluded} from '@vee-validate/rules';
